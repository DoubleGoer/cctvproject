        	...
        	<div class="tableFixHead col-sm-12 col-md-12">
				<table class="table">
					...
					<tbody style="overflow: scroll;">
						...
						<form action="amin.action" method="post">
        	...
        	<div class="tableFixHead col-sm-12 col-md-12">
				<table class="table">
					...
					<tbody style="overflow: scroll;">
						...
						<form action="amout.action" method="post">
						<c:forEach var="results" items="${dataA}">
		                    <tr>
		                    		<td><input type="checkbox" name="c_id" value="${results.c_id}"></td>
			                        <td><c:out value="${results.c_id}"/></td>
				                    <td><c:out value="${results.c_name}"/></td>
				                    <td><c:out value="${results.c_email}"/></td>
		                    </tr>
	                	</c:forEach>
